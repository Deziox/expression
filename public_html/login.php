...
<div class="container">
    ...
    <nav id="regNavbar" class="navbar navbar-dark navbar-expand-md py-0 px-5 fixed-top justify-content-around">
        <a href="index.php" class="navbar-brand"><img class="d-none d-lg-inline col-lg-1"
                                                      src="imgs/goldensquarelogo.png" alt="">EXPRS</a>
        ...
        <div class="jumbotron pt-5">
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    ...
                    <br>
                    <a type="button" class="btn btn-info" style="font-size: small" href="forgot_password.php">Forgot Your Password?</a>
                </div>
            </div>
        </div>
</div>
